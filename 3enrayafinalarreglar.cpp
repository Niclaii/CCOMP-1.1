...
void FichaIAD(char FX1, char FX2, char& FX3, char x, char o, int ubi) {
	if ((FX1 == FX2) && (FX1 != o)) {
		if ((FX3 != x) && (FX3 != o)) {
			FX3 = o;
		}
...
int main()
{
	...
	do
	{
		...
		if (singleplayer == true) { // No puede jugar la IA, help
			if (IAD == true) {
				if (JIA == true) {
					ubi = rand() % 9 + 1;
					JIA = false;
				...
				if (ubi == 1) {
					FichaIAD(F2, F3, F1, x, o, ubi);
					FichaIAD(F4, F7, F1, x, o, ubi);
					FichaIAD(F5, F9, F1, x, o, ubi);
				}
				else if (ubi == 2) {
					FichaIAD(F3, F1, F2, x, o, ubi);
					FichaIAD(F8, F5, F2, x, o, ubi);
				}
				else if (ubi == 3) {
					FichaIAD(F1, F2, F3, x, o, ubi);
					FichaIAD(F7, F5, F3, x, o, ubi);
					FichaIAD(F6, F9, F3, x, o, ubi);
				}
				else if (ubi == 4) {
					FichaIAD(F7, F1, F4, x, o, ubi);
					FichaIAD(F5, F6, F4, x, o, ubi);
				}
				else if (ubi == 5) {
					FichaIAD(F9, F1, F5, x, o, ubi);
					FichaIAD(F6, F4, F5, x, o, ubi);
					FichaIAD(F2, F8, F5, x, o, ubi);
					FichaIAD(F3, F7, F5, x, o, ubi);
				}
				else if (ubi == 6) {
					FichaIAD(F9, F3, F6, x, o, ubi);
					FichaIAD(F4, F5, F6, x, o, ubi);
				}
				else if (ubi == 7) {
					FichaIAD(F1, F4, F7, x, o, ubi);
					FichaIAD(F8, F9, F7, x, o, ubi);
					FichaIAD(F5, F3, F7, x, o, ubi);
				}
				else if (ubi == 8) {
					FichaIAD(F9, F7, F8, x, o, ubi);
					FichaIAD(F5, F2, F8, x, o, ubi);
				}
				else if (ubi == 9) {
					FichaIAD(F1, F5, F9, x, o, ubi);
					FichaIAD(F7, F8, F9, x, o, ubi);
					FichaIAD(F3, F6, F9, x, o, ubi);
				}
			}
		}
