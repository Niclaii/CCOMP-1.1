...
int main()
{
	...
	, CV35{ 0 }, CV41{ 0 }, CV42{ 0 }, CV43{ 0 }, CV44{ 0 }, CV45{ 0 }, CV51{ 0 }, CV52{ 0 }, CV53{ 0 }, CV54{ 0 }, CV55{ 0 };
	char figura{ ' ' }, replay{};
	...
	do
	{
		...
		// Formas de ganar
		FormasDeGanar(V11, V12, V13, PJugador1, PJugador2, jugador1, jugador2, FG1,CV11,CV12,CV13);
		FormasDeGanar(V11, V22, V33, PJugador1, PJugador2, jugador1, jugador2, FG2,CV11,CV22,CV33);//
		FormasDeGanar(V11, V21, V31, PJugador1, PJugador2, jugador1, jugador2, FG3,CV11,CV21,CV31);//
		FormasDeGanar(V12, V23, V34, PJugador1, PJugador2, jugador1, jugador2, FG4, CV12, CV23, CV34);//	
		FormasDeGanar(V12, V22, V32, PJugador1, PJugador2, jugador1, jugador2, FG5, CV12, CV22, CV32);//
		FormasDeGanar(V13, V23, V33, PJugador1, PJugador2, jugador1, jugador2, FG6, CV13, CV23, CV33);//
		FormasDeGanar(V13, V14, V15, PJugador1, PJugador2, jugador1, jugador2, FG7, CV13, CV14, CV15);//
		FormasDeGanar(V31, V22, V13, PJugador1, PJugador2, jugador1, jugador2, FG8, CV31, CV22, CV13);//
		FormasDeGanar(V13, V24, V35, PJugador1, PJugador2, jugador1, jugador2, FG9, CV13, CV24, CV35);//
		FormasDeGanar(V32, V23, V14, PJugador1, PJugador2, jugador1, jugador2, FG10, CV32, CV23, CV14);//
		FormasDeGanar(V14, V24, V34, PJugador1, PJugador2, jugador1, jugador2, FG11, CV14, CV24, CV34);//
		FormasDeGanar(V15, V25, V35, PJugador1, PJugador2, jugador1, jugador2, FG12, CV15, CV25, CV35);//
		FormasDeGanar(V33, V24, V15, PJugador1, PJugador2, jugador1, jugador2, FG13, CV33, CV24, CV15);//
		FormasDeGanar(V21, V22, V23, PJugador1, PJugador2, jugador1, jugador2, FG14, CV21, CV22, CV23);//
		FormasDeGanar(V21, V32, V43, PJugador1, PJugador2, jugador1, jugador2, FG15, CV21, CV32, CV43);//
		FormasDeGanar(V23, V24, V25, PJugador1, PJugador2, jugador1, jugador2, FG16, CV23, CV24, CV25);//
		FormasDeGanar(V22, V23, V24, PJugador1, PJugador2, jugador1, jugador2, FG17, CV22, CV23, CV24);//
		FormasDeGanar(V41, V32, V23, PJugador1, PJugador2, jugador1, jugador2, FG18, CV41, CV32, CV23);//
		FormasDeGanar(V23, V34, V45, PJugador1, PJugador2, jugador1, jugador2, FG19, CV23, CV34, CV45);//
		FormasDeGanar(V42, V33, V24, PJugador1, PJugador2, jugador1, jugador2, FG20, CV42, CV33, CV24);//
		FormasDeGanar(V24, V34, V44, PJugador1, PJugador2, jugador1, jugador2, FG21, CV24, CV34, CV44);//
		FormasDeGanar(V43, V34, V25, PJugador1, PJugador2, jugador1, jugador2, FG22, CV43, CV34, CV25);//
		FormasDeGanar(V25, V35, V45, PJugador1, PJugador2, jugador1, jugador2, FG23, CV25, CV35, CV45);//
		FormasDeGanar(V21, V31, V41, PJugador1, PJugador2, jugador1, jugador2, FG24, CV21, CV31, CV41);//
		FormasDeGanar(V31, V32, V33, PJugador1, PJugador2, jugador1, jugador2, FG25, CV31, CV32, CV33);//
		FormasDeGanar(V31, V42, V53, PJugador1, PJugador2, jugador1, jugador2, FG26, CV31, CV42, CV53);//
		FormasDeGanar(V31, V41, V51, PJugador1, PJugador2, jugador1, jugador2, FG27, CV31, CV41, CV51);//
		FormasDeGanar(V22, V32, V42, PJugador1, PJugador2, jugador1, jugador2, FG28, CV22, CV32, CV42);//
		FormasDeGanar(V32, V42, V52, PJugador1, PJugador2, jugador1, jugador2, FG29, CV32, CV42, CV52);//
		FormasDeGanar(V32, V33, V34, PJugador1, PJugador2, jugador1, jugador2, FG30, CV32, CV33, CV34);//
		FormasDeGanar(V32, V43, V54, PJugador1, PJugador2, jugador1, jugador2, FG31, CV32, CV43, CV54);//
		FormasDeGanar(V33, V23, V43, PJugador1, PJugador2, jugador1, jugador2, FG32, CV33, CV23, CV43);//
		FormasDeGanar(V22, V33, V44, PJugador1, PJugador2, jugador1, jugador2, FG33, CV22, CV33, CV44);//
		FormasDeGanar(V33, V43, V53, PJugador1, PJugador2, jugador1, jugador2, FG34, CV33, CV43, CV53);//
		FormasDeGanar(V51, V42, V33, PJugador1, PJugador2, jugador1, jugador2, FG35, CV51, CV42, CV33);//
		FormasDeGanar(V33, V44, V55, PJugador1, PJugador2, jugador1, jugador2, FG36, CV33, CV44, CV55);//
		FormasDeGanar(V33, V34, V35, PJugador1, PJugador2, jugador1, jugador2, FG37, CV33, CV34, CV35);//
		FormasDeGanar(V34, V44, V54, PJugador1, PJugador2, jugador1, jugador2, FG38, CV34, CV44, CV54);//
		FormasDeGanar(V52, V43, V34, PJugador1, PJugador2, jugador1, jugador2, FG39, CV52, CV43, CV34);//
		FormasDeGanar(V35, V45, V55, PJugador1, PJugador2, jugador1, jugador2, FG40, CV35, CV45, CV55);//
		FormasDeGanar(V53, V44, V35, PJugador1, PJugador2, jugador1, jugador2, FG41, CV53, CV44, CV35);//
		FormasDeGanar(V41, V42, V43, PJugador1, PJugador2, jugador1, jugador2, FG42, CV41, CV42, CV43);//
		FormasDeGanar(V42, V43, V44, PJugador1, PJugador2, jugador1, jugador2, FG43, CV42, CV43, CV44);//
		FormasDeGanar(V23, V33, V43, PJugador1, PJugador2, jugador1, jugador2, FG44, CV23, CV33, CV43);//
		FormasDeGanar(V43, V44, V45, PJugador1, PJugador2, jugador1, jugador2, FG45, CV43, CV44, CV45);//
		FormasDeGanar(V51, V52, V53, PJugador1, PJugador2, jugador1, jugador2, FG46, CV51, CV52, CV53);//
		FormasDeGanar(V52, V53, V54, PJugador1, PJugador2, jugador1, jugador2, FG47, CV52, CV53, CV54);//
		FormasDeGanar(V53, V54, V55, PJugador1, PJugador2, jugador1, jugador2, FG48, CV53, CV54, CV55);//
